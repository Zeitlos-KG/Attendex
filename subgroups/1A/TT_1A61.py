...
timetable = [
    ...
    ("UMA023", 1, "13:50", "14:40", "Tutorial"),
    ("UPH013", 1, "14:40", "15:30", "Tutorial"),

    # ---------------- WEDNESDAY ----------------
    ("UES102", 2, "08:00", "09:40", "Lab"),
    ("UES101", 2, "09:40", "11:20", "Lab", 1.0),
    ("UPH013", 2, "11:20", "13:00", "Lab"),
    ("UES101", 2, "15:30", "16:20", "Class"),
    ("UPH013", 2, "16:20", "17:10", "Class"),

    # ---------------- THURSDAY ----------------
    ("UES101", 3, "09:40", "11:20", "Tutorial", 1.0),
    ("UHU003", 3, "11:20", "12:10", "Class"),
    ("UMA023", 3, "12:10", "13:00", "Class"),

    # ---------------- FRIDAY ----------------
    ("UHU003", 4, "08:00", "09:40", "Lab"),
