...
timetable = [
    ...
    # THURSDAY
    ("UMA023",  3, "08:00", "08:50", "Tutorial"),
    ("UPH013",  3, "08:50", "09:40", "Tutorial"),
    ...
    # FRIDAY
    ("UES101",  4, "08:00", "09:40", "Tutorial", 1.0),  # 100-min ED Tutorial
    ("UPH013",  4, "09:40", "10:30", "Tutorial"),
    ("UMA023",  4, "10:30", "11:20", "Class"),
    ("UES101",  4, "11:20", "13:00", "Lab", 1.0),        # 100-min ED Lab
]